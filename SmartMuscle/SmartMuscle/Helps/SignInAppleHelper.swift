...
//  SmartMuscle
//
//  Created by william torres dias dos santos on 21/06/23.
//
...
final class SignInAppleHelper: NSObject {
    ...
    typealias completionResult = (Result<SignInWithAppleResult, Error>) -> ()
    
    private var currentNonce: String?
    private var completionHandler: (completionResult)? = nil
    ...
    public func startSignInWithAppleFlow(completion: @escaping (Result<SignInWithAppleResult, Error>) -> ()) {
